...
As seguintes categorias são usadas para classificar tipos de dados pessoais:
  ...
  O termo bir é uma abreviação de `"Digito binário` e representa a menos parte de dados. Cada bit pode ter apenas dois valores possiveis : 0 ou 1
...
Largura de banda é a capacidade de um meio de transportar dados. A largura de banda digital mede a q quantidade de dados que podem fluir de um lugar para o outro durante um terminado tempo. A largura de banda costuma ser medida pelo número de bits que (teoricamente) podem ser enviados através da midia em um segundo. Estas são as medidas comuns de largura de banda:
